...
export default function Budget() {
  const balancePreviousMonths = 693.54;
  const percentDifference = 2.4;
  let sum = 0;
  ...
  const balanceThisMonth = balancePreviousMonths + sum;
    ...
    <div className="flex flex-col max-w-xl">
      <div className="bg-soft-red flex justify-between p-4 my-2 rounded-xl">
        <div className="flex flex-col">
          ...
          <h2 className="text-3xl md:text-5xl">${balanceThisMonth}</h2>
        </div>
        <Image src="/logo.svg" height={65} width={65} alt="Logo" />
      </div>
      <div className="bg-cream p-4 rounded-xl">
        <h3 className="text-3xl md:text-5xl text-dark-brown">Spending - Last 7 days</h3>
        ...
        <div className="border-t-2 border-medium-brown flex justify-between pt-4">
          <div className="flex flex-col justify-center">
            ...
            <h4 className="text-3xl md:text-5xl text-dark-brown">${sum}</h4>
          </div>
          <div className="flex flex-col content-end justify-center">
            <h5 className="text-2xl text-dark-brown text-right">{percentDifference}%</h5>
